...
$('#cake').click(function(e){
    if ( !$(e.target).hasClass("candle") && !$(e.target).hasClass("flame")){
        if(!$(this).hasClass('piece') && cake_click==0){
            ...
            if(envelope_click==0){
                showPopUp(1500,"There is a letter near the table.<br> It must contain something interesting.<br> Let's open it and read it together!")
                return
            }
            ...
            showPopUp(200, "You shouldn't have any more sweets—you're already sweet enough :)");
            return
        }
    }
